...
public enum ItemType {
    ...
    WOODEN_SWORD("minecraft:wooden_sword", 268),
    WOODEN_SHOVEL("minecraft:wooden_shovel", 269),
    WOODEN_PICKAXE("minecraft:wooden_pickaxe", 270),
    WOODEN_AXE("minecraft:wooden_axe", 271),
    ...
    GOLDEN_SWORD("minecraft:golden_sword", 283),
    GOLDEN_SHOVEL("minecraft:golden_shovel", 284),
    GOLDEN_PICKAXE("minecraft:golden_pickaxe", 285),
    GOLDEN_AXE("minecraft:golden_axe", 286),
    STRING("minecraft:string", 287),
    FEATHER("minecraft:feather", 288),
    GUNPOWDER("minecraft:gunpowder", 289),
    WOODEN_HOE("minecraft:wooden_hoe", 290),
    STONE_HOE("minecraft:stone_hoe", 291),
    IRON_HOE("minecraft:iron_hoe", 292),
    DIAMOND_HOE("minecraft:diamond_hoe", 293),
    GOLDEN_HOE("minecraft:golden_hoe", 294),
    ...
    GOLDEN_HELMET("minecraft:golden_helmet", 314),
    GOLDEN_CHESTPLATE("minecraft:golden_chestplate", 315),
    GOLDEN_LEGGINGS("minecraft:golden_leggings", 316),
    GOLDEN_BOOTS("minecraft:golden_boots", 317),
    ...
    ENCHANTED_GOLDEN_APPLE("minecraft:golden_apple", 322, 1),
    ...
    GOLDEN_HORSE_ARMOR("minecraft:golden_horse_armor", 418),
