 ...
 * <p>
 * The ConfigurationCommandService serves as a point of entry into the configuration module implementation. It provides
 * a method to reload a {@code Configuration} and recreate the object that its mapped to.
 */
